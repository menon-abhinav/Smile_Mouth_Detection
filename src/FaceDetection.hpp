 ...
 * @brief Defines the FaceDetection class for using a Mediapipe face detector model, including loading images, running inference, and extracting regions of interest (ROI).
 */
