...
[reduce binary size](reduce_binary_size.md).
...
[build above files with docker](reduce_binary_size.md#selectively_build_tensorflow_lite_with_docker).
...
[Reduce TensorFlow Lite binary size](reduce_binary_size.md) section.
