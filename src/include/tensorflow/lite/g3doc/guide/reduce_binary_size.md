...
For the models with the [Select TF ops](ops_select.md):
...
Please see the
[Building locally section](build_ios.md#building_locally) to set up the
build environment and configure TensorFlow workspace and then follow the
[guide](build_ios.md#selectively_build_tflite_frameworks) to use the
